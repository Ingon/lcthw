...
int Shell_exec(Shell template, ...)
{
    ...
    check(template.replace_count == arg_replace_count, "Expected %d arguments but replaced %d arguments", template.replace_count, arg_replace_count);
